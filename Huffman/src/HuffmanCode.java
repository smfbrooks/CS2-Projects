...
//		System.out.println(System.in);
		System.out.print("Enter the name of text file to be compressed: ");
...
//		String text = input.nextLine();
		...
		int[] counts = getCharacterFrequency(file);
	...
	public static int[] getCharacterFrequency(File file) throws IOException {
